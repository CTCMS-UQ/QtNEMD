...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.temp_spinbox)
        ...
        self.npart_spinbox = QtWidgets.QSpinBox(self.centralwidget)
        self.npart_spinbox.setMinimumSize(QtCore.QSize(146, 0))
        self.npart_spinbox.setMaximumSize(QtCore.QSize(146, 16777215))
        self.npart_spinbox.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.npart_spinbox.setMaximum(2500)
        self.npart_spinbox.setObjectName("npart_spinbox")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.npart_spinbox)
        self.npart_label_2 = QtWidgets.QLabel(self.centralwidget)
        self.npart_label_2.setObjectName("npart_label_2")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.npart_label_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.npart_label_2.setText(_translate("MainWindow", "Num. Particles"))
